...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("encrypted_creds", sa.LargeBinary, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("progress_meta", sa.JSON, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("panes_config", sa.JSON, nullable=True),
        sa.Column("cleaning_cfg", sa.JSON, nullable=True),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            nullable=False,
...
def downgrade() -> None:
    op.drop_table("saved_workbenches")
    op.drop_table("jobs")
